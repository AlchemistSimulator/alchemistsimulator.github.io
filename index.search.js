var relearn_search_index = [
  ...
  },
  {
    ...
    "description": "This website hosts the documentation of the Alchemist Simulator, created towards the end of 2010 as a by-product of the European Project SAPERE, and grown ever since into a full-fledged simulation framework.\nIf your browser supported the video tag, there would be a nice video. Where to start We recommend that you check out our showcase to understand what you can simulate, and our tutorials to learn how to fiddle with the tool.",
    "tags": [],
  ...
  },
  {
    "breadcrumb": "The Alchemist Simulator \u003e Reference",
    "content": "",
    "description": "Javadoc API docs. Kotlin classes are not captured as well as in KDoc, so the KDoc could be a better pick for most tasks.",
    "tags": [
      "Javadoc",
      "Api Docs"
    ],
