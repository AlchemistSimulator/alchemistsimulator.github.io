var relearn_searchindex = [
  ...
  {
    "breadcrumb": "The Alchemist Simulator \u003e How-to Guides \u003e Execution",
    "content": "In some cases you may need to test the same simulation configuration with different parameters. Suppose for example that you want to see what happens when you place a bunch of pedestrian in a circle (for sake of simplicity we’ll ignore their behavior). You may want to observe the scenario with 50 pedestrians placed in a 5 meters radius circle. Then you may like to observe it with 100 pedestrian and perhaps by changing the circle radius also. Instead of re-writing the configuration file over-and-over for each parameter combination, Alchemist offers the possibility to write the configuration once, and it will then derive a batch of simulations from the same configuration.\nConfiguring batch simulations To exploit this mechanism, you must declare the “parameters” as variables. In our example, they would be the number of pedestrian and the radius of the circle where to place them. Let’s write the configuration file, specifying that we want to test the simulation with 10, 30, 50, 70, 90 pedestrians and a 5, 10, 15 meters circle radius:\nClick to show / hide code Info To understand how variables work refer to this page. You may also want to learn how to export data and specifying termination criteria.\nRunning batch simulations Using the launcher configuration (recommended) The modern approach to running batch simulations is to configure the launcher directly in your simulation file. Add a launcher section specifying which variables to batch:\n# Your simulation configuration with variables variables: nodeCount: \u0026nodeCount type: LinearVariable parameters: [5, 5, 15, 10] # Start: 5, Step: 5, End: 15, Default: 10 range: \u0026range type: LinearVariable parameters: [1, 1, 3, 2] # Start: 1, Step: 1, End: 3, Default: 2 # Configure the launcher for batch execution launcher: parameters: batch: [nodeCount, range] # Rest of your simulation configuration... deployments: - type: Circle parameters: [*nodeCount, 0, 0, 5] # ... rest of configuration Then run the simulation with:\njava -jar ./build/shadow/alchemist-full-*-all.jar run simulation.yml Using command-line variable overrides Alternatively, you can specify batch variables from the command line using the --override option:\njava -jar ./build/shadow/alchemist-full-*-all.jar run simulation.yml --override \" launcher: parameters: batch: [nodeCount, range] \" Headless execution For automated or server environments, use headless mode:\nCI=true java -jar ./build/shadow/alchemist-full-*-all.jar run simulation.yml Understanding batch execution Under the hood, the simulator will compute the cartesian product of all possible values of the variables specified in the batch list. Variables not included in the batch will use their default value.\nFor example, with:\nnodeCount: [5, 10, 15] (3 values) range: [1, 2, 3] (3 values) The simulator will execute 3 × 3 = 9 different simulation configurations.\nComplete working example Here’s a complete simulation file that demonstrates batch execution with the modern launcher configuration:\nClick to show / hide code This will execute 3 × 3 = 9 different simulation configurations:\nnodeCount: [5, 10, 15] range: [1, 2, 3] Results will be exported to CSV files with the naming pattern batch_results_*.csv.",
  ...
  },
  {
    ...
    "content": "One common way to deploy nodes in a bidimensional space is on a grid. Grid-like deployments can be easily performed in Alchemist leveraging the Grid Deployment.\nThe following example shows a grid centered in (0, 0), with nodes distanced of 0.25 both horizontally and vertically. Click to show / hide code Often, symmetric structures may induce corner behaviors in self-organising systems, and real-world “grid” deployments are not usually geometrically perfect. Indeed, it is common to perturb the grid shape randomly, in order to account for potential irregularities of the real-world system being simulated. Grid supports perturbation natively: for instance, here is an example of a grid where positions are randomly perturbed of ±0.1 distance units.\nClick to show / hide code",
  ...
  },
  {
    ...
    "uri": "/showcase/2023-macroswarm/index.html"
  },
  {
    "breadcrumb": "The Alchemist Simulator \u003e Showcase",
  ...
  {
    "breadcrumb": "The Alchemist Simulator \u003e Showcase",
    "content": "title: A Field-Based Approach for Runtime Replanning in Swarm Robotics Missions (2025) summary: “Experimental evaluation of a decentralized replanning mechanism grounded in Aggregate Computing to handle robot failures and environmental changes in real-time.” Experimental artefact and simulation setup available at https://github.com/angelacorte/experiments-2025-acsos-robots This work was presented at the 2025 IEEE International Conference on Autonomic Computing and Self-Organizing Systems (ACSOS) (DOI: 10.1109/ACSOS66086.2025.00017).\nThis article has won the Best Student Paper Award at ACSOS 2025.\nAbstract Ensuring mission success for multi-robot systems in unpredictable environments requires robust mechanisms to react to events like robot failures by adapting plans in real-time. Adaptive mechanisms are especially needed for large teams deployed in areas with unreliable network infrastructure, where centralized control is impractical.\nThis paper proposes a field-based runtime task replanning approach grounded in the Aggregate Computing (AC) paradigm. By representing the mission and environment as continuously evolving computational fields, robots can make decentralized decisions and collectively adapt ongoing plans.\nThe core of the approach focuses on two strategies:\nGossip-based approach: Every robot independently monitors the collective state (active nodes and task status) and triggers replanning upon detecting changes. Leader-based approach: A leader is dynamically elected via distributed consensus to initiate and compute the replan, reducing the overall computational load. The results show that the proposed approach scales linearly with team size and maintains performance levels close to an “oracle” centralized replanner, provided the communication range is sufficient to maintain network connectivity.\nExperiment description The evaluation aims to verify the resilience and scalability of the field-based approaches in a simulated Multi-Robot Task Allocation (MRTA) scenario.\nThe mission requires a team of $m$ robots to service $n$ tasks. Robots must navigate from a source to a destination while stopping at task locations. The experiments are designed to test how the swarm reacts when robots fail or the environment changes.\nWe compared four main strategies:\nGossip Based: Fully decentralized, high resilience but higher message overhead. Leader Based: Distributed leader election, lower overhead but dependent on leader stability. Oracle: A baseline with global knowledge (centralized). Late-Stage: A baseline where robots only check for missed tasks at the end of their plan. The simulations varied several parameters:\nTeam Size ($m$): 5, 10, 20, 40 robots. Task-to-Robot Ratio ($n/m$): 0.5, 1, 2, 4. Communication Range ($R$): 20 m (sparse), 50 m, 100 m, and fully connected. Failure Rate: Mean time between failures ranging from 1,000s to 50,000s. Results The experiments demonstrate that field-based replanning significantly improves mission efficiency compared to non-adaptive baselines.\nKey findings include:\nConnectivity: A minimum communication range is required to allow the “fields” to propagate information. Once met, the performance gap between decentralized and centralized (Oracle) approaches becomes negligible. Resilience: The Gossip strategy proves most robust against high failure rates, as it does not rely on specific nodes (like leaders) to coordinate. Efficiency: In large-scale scenarios, the field-based approach reduces the time to mission completion by up to 30% compared to the Late-Stage baseline. Simulation Sequence The following animation shows the swarm in action, where robots dynamically re-allocate tasks as failures occur or tasks are completed:\nIn the visualization, red dots represent active tasks, green dots represent completed tasks, and gray squares indicate failed robots. The pink lines show the paths currently planned by the aggregate logic.",
    "description": "Experimental evaluation of a decentralized replanning mechanism grounded in Aggregate Computing to handle robot failures and environmental changes in real-time.",
    "tags": [
      "Simulation",
      "Aggregate Computing",
      "Path Replanning"
    ...
    "uri": "/showcase/2025-acsos-replanning/index.html"
  },
  {
    "breadcrumb": "The Alchemist Simulator \u003e Showcase",
    "content": "Experimental Information Experimental artefact and simulation setup available at\nhttps://github.com/angelacorte/fieldVMC\nThis artefact originates from the preliminary work\n“An Aggregate Vascular Morphogenesis Controller for Engineered Self-Organising Spatial Structures” presented at ACSOS 2024 (DOI: 10.1109/ACSOS61780.2024.00032).\nThe approach has subsequently been extended and formalised in the journal article\n“FieldVMC: an asynchronous model and platform for self-organising morphogenesis of artificial structures”,\npublished in Complex \u0026 Intelligent Systems (2026) (DOI: 10.1007/s40747-025-02141-y).\nTechnical Note This experiment uses an old Collektive version: 13.1.1.\nAbstract In the field of evolutionary computing, the concept of Vascular Morphogenesis Controller (VMC) has been proposed in to model the growth of artificial structures over time.\nA thorough analysis of the VMC model revealed some limitations:\nassumes the organization structure is a tree, here intended as a directed acyclic graph with a single root and with a single path connecting the root with each leaf; the model is implicitly synchronous, as it assumes that (i) the evaluation of the nodes must proceed from the leaves to the root (and back), and (ii) the update of the whole tree occurs atomically. Although, depending on the context, these assumptions may be acceptable, in general they may induce (possibly hidden) abstraction gaps when VMC is used to model real-world systems, and, at the same time, limit the applicability of the pattern to engineered morphogenetic systems.\nTo address these limitations, in this work, we propose FieldVMC: a generalisation of the VMC model as a field-based computation, in the spirit of the Aggregate Programming (AP) paradigm.\nMore specifically, FieldVMC reinterprets the VMC dynamics as an aggregate field computation, enabling decentralised and asynchronous execution over arbitrary network topologies (i.e., undirected graphs rather than trees). Under this formulation, the hierarchical structures typical of VMC emerge from local self-organising interactions among nodes rather than from an explicitly maintained tree structure.\nSubsequent work formally proves that FieldVMC is a monotonic extension of the original VMC model, meaning that it can reproduce the behaviours of VMC while enabling additional phenomena such as structure merging, splitting, and optimisation, and that the resulting system is self-stabilising under eventual quiescence.\nExperiment description The experiments want to show the capabilities of the proposed model in generating self-organising spatial structures. The goal of this evaluation is to show that the proposed FieldVMC supports the construction of the same structures of its predecessor, and, in addition, that it can work in scenarios not previously investigated. In the extended journal evaluation, experiments are organised into three classes:\nType A: comparison between VMC and FieldVMC (e.g., self-construction and self-healing), Type B: analysis of new phenomena enabled by FieldVMC (self-integration, self-division, self-optimisation), Type C: scalability analysis focusing on communication costs and data rates. The experiments presented in this artefact correspond to scenarios exploring the emergent behaviours enabled by the aggregate formulation. To this end, we designed a set of experiments:\nlegacySelfConstruction: self-construction from a single node (growth from seed), selfDivision: self-division after disruption (network segmentation) with no regeneration (cutting). The segmentation is performed by removing a part of the structure after 500 simulated seconds, and the nodes are not able to regenerate the missing part; selfIntegration: self-integration of multiple FieldVMC systems (grafting). Two distinct structures are created, and after 500 simulated seconds, they are merged into a single structure; selfSegmentation: self-segmentation of a larger structure (budding). Two distinct structures are created with possibly more than leader each; after 500 simulated seconds, they are merged into a single structure; selfOptimisation: self-optimisation of multiple large structures into a more efficient one (abscission and regrowth). Sparse nodes are created far from success and resource sources, with spawning and destruction of nodes enabled, the structure is allowed to grow and optimize itself. selfConstructionClassicVMC: implementation of the classic VMC model, starting from a single node, with spawning of new nodes but no destruction of them; selfHealingClassicVMC: same of the previous one, but with the cutting of a part of the structure after 500 simulated seconds; selfConstructionFieldVMC: implementation of our FieldVMC model, with optimized parameters to be as close as possible to the classic VMC model; selfHealingFieldVMC: same of the previous one, but with the cutting of a part of the structure after 500 simulated seconds; selfConstructionFieldVMCOptimizer: launcher of our FieldVMC model in order to evaluate the optimized parameters used in the comparison with the classic VMC model. More generally, these scenarios illustrate how the aggregate formulation allows the system to naturally support structural operations such as growth, merging, division, and reconfiguration, which are difficult to express in the original VMC formulation.\nResults In all the experiments, the cyan area represents the resource and the yellow area is the success, with darker shades indicating higher values. Nodes are represented as circles. The root is identified by a dark outer circumference. The size of a circle depends on the amount of resource and success received relative to all other nodes in the system: we fix the maximum possible size D, compute the maximum amount of resource R and the maximum amount of success S across all nodes in the system. Then, for each node in the system with success s and resource r, we determine its size d proportionally to D as: d = D × (r + s)/(R + S)\nTheir color depends on the amount of resource nodes have and is assigned based on the hue of the HSV color space, with the most resource associated with indigo, and the lowest with red. Dashed lines are communication channels, solid black lines represent the tree structure, and green (resp. orange) lines depict the resource (resp. success) distribution flows, the thicker they are, the more resource (resp. success) is being transferred.\nSome examples of the generated structures are shown below:\nStarting Structure Self-Organised Structure Structure after cutting a part of it Self-Organised Structure after the cutting The images show the evolution of a structure from a starting configuration to a self-organized structure, after a part of the structure has been removed.\nAs seen in the sequence below, the structure evolves from a single node to a more complex structure. Firstly, the structure results to expand towards the center of the available resources. This happens because the spawned nodes are in a zone with higher resources, used as weight in the leader election phase, thus the newly created node gets elected as the new leader, which results in an expansion towards the center of the resource layer. While the root gains more resources, nodes will spawn children based on their local success, meaning that the nodes which sense more success from the environment have higher probability and capabilities to spawn new children, resulting in an expansion towards the center of the success layer. The structure then stabilizes in what appears to be the optimal configuration, and the structure stops evolving.\nSequence of images showing the evolution in time of the structure in the oneRoot experiment.",
  ...
  {
    "breadcrumb": "The Alchemist Simulator \u003e How-to Guides \u003e Simulation \u003e Create rich environments",
    "content": "Before reading the following explanation you may want to look at the explanation of the cognitive agents and then at how to work with them.\nConfiguring the physics environment The simulator is equipped with a special type of Environment named EnvironmentWithDynamics which performs collision detection and response between nodes and with obstacles.\nHere’s a minimal configuration of a physics simulation: Click to show / hide code It’s also possibile to specify an image path for including obstacles in the environment Click to show / hide code Adding nodes to the environment Nodes added to the EnvironmentWithDynamics are required to have at least a PedestrianProperty, a PhysicalPedestrian and a OccupiesSpaceProperty.\nHere’s an example: Click to show / hide code Configuring nodes programs When using the EnvironmentWithDynamics, any suitable Reaction can be used, however, in order to take advantage of the physical micro-interactions between nodes such as avoidance, pushing behavior and falls, derived from the work of Pelechano et al. you need to use the PhysicalBlendedSteering.\nHere’s an example: Click to show / hide code Updating the physics engine The EnvironmentWithDynamics internally uses a GlobalReaction called PhysicsUpdate to update nodes positions. By deault this reaction uses a DiracComb with a default rate. If you want, it’s possible to override the reaction with a custom TimeDistribution and update rate.\nHere’s some examples: Click to show / hide code Click to show / hide code Click to show / hide code",
  ...
  },
  {
    ...
    "uri": "/showcase/2024-scarlib/index.html"
  },
  {
    "breadcrumb": "The Alchemist Simulator \u003e Showcase",
    "content": "From Simulation and detailed description publicly available at https://github.com/anitvam/experiment-2025-acsos-ship-clustered-comm .\nAbstract Maritime communication networks face unique challenges due to the dynamic and sparse distribution of vessels, variable environmental conditions, and heterogeneous technological constraints. With the increasing trend toward autonomy in maritime operations, these challenges become more pronounced.\nModern maritime navigation systems integrate numerous high-bandwidth sensors—including cameras and LiDAR—to enhance environmental perception, whose exploitation generates increased data rate demand. The increase is in contrast to traditional ship communication systems, which provide data rates in the order of kilobits per second.\nThis work proposes robust, multi-mean, collective adaptive software infrastructures to resiliently improve data collection by relaying data streams across multiple vessels. In particular, we introduce a method to form dynamic clusters of vessels whose information is summarised and then transmitted, raising the probability that the information reaches its destination. We validate our approach through simulation and show that the proposed clustering mechanism is capable of scaling up as new vessels are equipped with improved communication technologies.\nExperiment description Objective The goal of this experiment is to evaluate the performance of different communication strategies for maritime vessels in the Kiel area. We evaluate the performance of the communication strategies in terms of data rate, i.e., the amount of data that can be communicated.\nThe communication algorithms compared in this experiment are:\nDirect Communication: vessels communicate directly with shore stations, which is the current standard communication method. If vessels are out of range of communication with shore stations, they rely on satellite communication. Distance-based Multi-Relay Communication (Dist-MR): vessels communicate relaying messages to each other to improve communication range. The relay is chosen based on the distance between vessels, i.e., the closest vessel to the sender is chosen as a relay. Data Rate-based Multi-Relay Communication (DR-MR): vessels communicate relaying messages to each other to improve communication range. The relay is chosen based on the data rate, i.e., the vessel with which the data rate is highest is chosen as a relay. Collective Summarization Clusters (CSC): Like Dist-MR but the vessels are grouped into clusters, and each cluster has a leader that collects the messages from the other vessels in the cluster and sends them to the nearest relay, which can be a shore station or another vessel in a cluster.\nSetup The experiment uses Alchemist Simulator to simulate vessels movements taken from a six-hour time window from August 18, 2022, from 4:00 to 10:00 Universal Time Coordinated (UTC) (6:00 to 12:00 Central European Summer Time (CEST)—Kiel local time).\nWe assume each vessel to be equipped with:\na VHF Automatic Packet Reporting System (APRS) device and a LoRaWAN class-C (bidirectional communication) device for long-range communication; a 5G consumer-grade module (similar to the ones used in mobile phones); and a Wi-Fi-direct capable device. Furthermore, we assume that a vessel can be equipped with a 5G cellular tower with probability p5G.\nWe use openly available data to locate the positions of the land stations. Similarly, we use openly available data to understand where the existing 5G infrastructure is located and their specific technology.\nWe assume that all ships intend to communicate a data stream d = 3 Mbit/s to the land station, approximately equivalent to the bitrate of a compressed 720p video stream.\nThe simulation is performed with two free variables:\np5G: Controlling the probability of a vessel being equipped with a 5G tower. We let p5G range in [0, 0.01, 0.02, 0.05, 0.1, 0.5, 1]. f: Controlling the aggregate program round frequency. We let f range in [1 / 60, 0.1, 0.2]Hz. Every experiment is performed 100 times, each time with a different seed. Results Among the tested methods, CSC achieves the highest average data rate in all simulation configurations. In particular, CSC is also the approach that scales better as infrastructure improves, demonstrating better adaptability to the presence of 5G equipped vessels. The DR-MR generally underperforms, even compared with Dist-MR and the current baseline. This counterintuitive result is most likely due to vessels with a good data rate being overly selected and ending up with too many streams to relay, thus causing overuse of few channels and underuse of others. These results suggest that the approach could be amended, for instance, by considering the number of children per relay as a factor in the relay selection process.\nImages",
    "description": "Multi-Relay Self-Adaptive Communication Network in Maritime Context for International Conference on Autonomic Computing and Self-Organizing Systems (2025).",
    "tags": [
      "Simulation",
      "Aggregate Computing",
    ...
    "uri": "/showcase/2025-acsos-ships/index.html"
  },
  {
    "breadcrumb": "The Alchemist Simulator \u003e How-to Guides",
  ...
  },
  {
    ...
    "description": "",
    "tags": [],
    "title": "Tag :: Macroswarm",
    "uri": "/tags/macroswarm/index.html"
  },
  {
    "breadcrumb": "The Alchemist Simulator \u003e Tags",
    "content": "",
  ...
  },
  {
    ...
    "description": "",
    "tags": [],
    "title": "Tag :: Multi-Agent Reinforcement Learning",
    "uri": "/tags/multi-agent-reinforcement-learning/index.html"
  },
  {
    "breadcrumb": "The Alchemist Simulator \u003e Tags",
    "content": "",
  ...
  },
  {
    ...
    "description": "",
    "tags": [],
    "title": "Tag :: Path Replanning",
    "uri": "/tags/path-replanning/index.html"
  },
  {
    "breadcrumb": "The Alchemist Simulator \u003e Tags",
    "content": "",
  ...
  },
  {
    ...
    "description": "",
    "tags": [],
    "title": "Tag :: Self-Adaptive Networks",
    "uri": "/tags/self-adaptive-networks/index.html"
  },
  {
    "breadcrumb": "The Alchemist Simulator \u003e Tags",
    "content": "",
    "description": "",
    "tags": [],
    "title": "Tag :: Self-Organising Coordination Regions",
    "uri": "/tags/self-organising-coordination-regions/index.html"
  },
  {
    "breadcrumb": "The Alchemist Simulator \u003e Tags",
    "content": "",
